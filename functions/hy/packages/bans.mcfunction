...
execute @a[scores={warn=1}] ~ ~ ~ execute @s[scores={tempkick=1}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§¶§cHydra ► [1/3] Kicked a Player For using NBT"}]}
execute @a[scores={warn=1}] ~ ~ ~ execute @s[scores={tempkick=2}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§¶§cHydra ► [1/3] Kicked a Player For Flying"}]}
execute @a[scores={warn=1}] ~ ~ ~ execute @s[scores={tempkick=3}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§¶§cHydra ► [1/3] Kicked a Player For Changing Gamemode"}]}
execute @a[scores={warn=1}] ~ ~ ~ execute @s[scores={tempkick=4}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§¶§cHydra ► [1/3] Kicked a Player For Killaura"}]}
...
execute @a[scores={warn=2}] ~ ~ ~ execute @s[scores={tempkick=1}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§¶§cHydra ► [2/3] Kicked a Player For using NBT"}]}
execute @a[scores={warn=2}] ~ ~ ~ execute @s[scores={tempkick=2}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§¶§cHydra ► [2/3] Kicked a Player For Flying"}]}
execute @a[scores={warn=2}] ~ ~ ~ execute @s[scores={tempkick=3}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§¶§cHydra ► [2/3]  Kicked a Player For Changing Gamemode"}]}
execute @a[scores={warn=2}] ~ ~ ~ execute @s[scores={tempkick=4}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§¶§cHydra ► [2/3] Kicked a Player For Killaura"}]}
...
execute @a[scores={warn=3}] ~ ~ ~ execute @s[scores={tempkick=1}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§¶§cHydra ► [3/3] Banned a Player For using NBT"}]}
execute @a[scores={warn=3}] ~ ~ ~ execute @s[scores={tempkick=2}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§¶§cHydra ► [3/3] Banned a Player For Flying"}]}
execute @a[scores={warn=3}] ~ ~ ~ execute @s[scores={tempkick=3}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§¶§cHydra ► [3/3] Banned a Player For Changing Gamemode"}]}
execute @a[scores={warn=3}] ~ ~ ~ execute @s[scores={tempkick=4}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§¶§cHydra ► [3/3] Banned a Player For Killaura"}]}
execute @a[scores={warn=3}] ~ ~ ~ execute @s[scores={tempkick=4}] ~ ~ ~ scoreboard players reset @s Killaura
 
execute @a[scores={warn=3}] ~ ~ ~ execute @s ~ ~ ~ tellraw @a[scores={tempkick=3}]
