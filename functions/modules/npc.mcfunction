...
#warn1
execute @e[type=npc,tag=!server] ~~~ execute @a[scores={npcwarn=1},tag=!staff] ~~~ w @a[tag=staff] §b@s §ewas §cWARNED §efor the §aFIRST time §eby HYDRA §aAnti Cheat for placing a command block minecart or npc!
...
#warn2
execute @e[type=npc,tag=!server] ~~~ execute @a[scores={npcwarn=2},tag=!staff] ~~~ w @a[tag=staff] §b@s §ewas §cWARNED §efor the §aSECOND time §eby HYDRA §aAnti Cheat for placing a command block minecart or npc!
